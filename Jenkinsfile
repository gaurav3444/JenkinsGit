pipeline {
    ...
    stages {
        ...
        stage('Security Scan') {
            ...
            post {
                success {
                    emailext attachLog: true, body: "Security Scan successful", subject: "Security Scan stage succeeded",  to: '3444gauravsharma@gmail.com'
                }
                failure {
    ...
    post {
                success {
                    emailext attachLog: true, body: "overall Build was successful", subject: "overall Build succeeded",  to: '3444gauravsharma@gmail.com'
                }
                failure {
